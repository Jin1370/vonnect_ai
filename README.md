...
- **🎞️ 크롭(Crop) 범위 지정 기능**: 사용자 편의를 위해 자를 범위를 슬라이더로 직접 지정하고 미리보기로 확인할 수 있습니다.
- **📜 번역 자막 표시 옵션**: 영상 내에 번역된 자막을 입힐지 여부를 사용자가 직접 선택할 수 있습니다.
...
USE_BASE_VOICE=false # true일 경우 클로닝을 생략하고 기본 목소리를 사용합니다.
```
