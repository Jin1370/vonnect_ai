                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                {formatSpeakerLines(result.transcript).map(
                                    (line, i) => {
                                        const color =
                                            line.speakerIdx !== null
                                                ? SPEAKER_COLORS[
                                                      line.speakerIdx %
                            ...
                            <div
                                style={{
                                    ...
                                    padding: "1rem",
                                    background:
                                        "linear-gradient(rgba(168,85,247,0.1), rgba(168,85,247,0.05))",
                                    borderRadius: "8px",
                            ...
                            >
                                ...
                                {formatSpeakerLines(result.translatedText).map(
                                    (line, i) => {
                                        const color =
                                            line.speakerIdx !== null
                                                ? SPEAKER_COLORS[
